...
from models import GT, Trans, LSTM, GRU, GCNnet,Seq2Seq,T_CNN
...
class processor(object):
    def __init__(self, args):
        ...
        model_dict = {'GT':GT, 'Trans': Trans, 'LSTM': LSTM,
                      'GRU': GRU, 'GCNnet':GCNnet,
                      'Seq2Seq': Seq2Seq, 'TCNN': T_CNN}
    ...
    def test(self):
        ...
        print('Test_ADE: {} Test_FDE: {}'
        .format( ADE, FDE))
        return  ADE, FDE, time.time()-st
    ...
    def test_epoch(self):
        ...
        for b_id, batch in enumerate(test_loader):
            ...
            tar_y = inputs[0][self.args.obs_length:, :, :2].detach().cpu().numpy()
